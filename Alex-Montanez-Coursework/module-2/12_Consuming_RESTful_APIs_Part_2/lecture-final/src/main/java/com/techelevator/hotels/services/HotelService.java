...
public class HotelService {
    ...
    public Reservation addReservation(Reservation newReservation) {
        // Setting up the headers so we can say the body is in JSON
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);

        // Wrap the headers and the serialized Reservation into an HttpEntity
        HttpEntity<Reservation> entity = new HttpEntity<>(newReservation, headers);

        // Send the whole entity to the server as part of a POST
