...
function getFullAddressesOfProperties(properties) {
    // Use map to create a new array of formatted addresses
...
function findLargest(searchArray) {
    ...
    searchArray.forEach(function(item) {
        // If largest is undefined, set it to the current item
        if (largest === undefined) {
            largest = item;
        } else {
            // Compare the current item with the largest so far
            if (item > largest) {
                largest = item;
            }
        }
