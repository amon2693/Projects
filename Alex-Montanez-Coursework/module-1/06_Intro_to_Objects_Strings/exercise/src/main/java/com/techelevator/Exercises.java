...
public class Exercises {
	...
	public String nonStart(String a, String b) {
		String word = a.substring(1) + b.substring(1);
		return word;
	}
	...
	public String left2(String str) {
		String one = str.substring(2) + str.substring(0, 2);
		return one;
	}
	...
	public String right2(String str) {
		String one = str.substring(str.length() - 2) + str.substring(0, str.length() -2);
		return one;
	}
	...
	public String theEnd(String str, boolean front) {
		String one;
		if(front == false) {
			one = str.substring(str.length() - 1);
		} else {
	...
	public String withoutEnd2(String str) {
		...
		if(str.length() <= 2){
			...
			one = str.substring(1, str.length() -1);
		}
		return one;
	}
	...
	public String nTwice(String str, int n) {
		String one = str.substring(0, n) + str.substring(str.length() - n);
		return one;
	}
	...
	public String twoChar(String str, int n) {
		...
		if(n < 0 || n > str.length() -2) {
			one = str.substring(0, 2);
		} else {
			one = str.substring(n, n + 2);
		}
			return one;
	}
	...
	public boolean hasBad(String str) {
		if (str.length() == 0){
			return false;
		} else if ((str.substring(0).contains("bad") || str.substring(1).contains("bad"))) {
		return true;
		}
	return false;
	}
	...
	public boolean doubleX(String str) {
		...
		// Check if "x" is immediately followed by another "x"
		if (firstXIndex != -1 && firstXIndex + 1 < str.length()) {
			return str.charAt(firstXIndex + 1) == 'x';
		}
		return false; // Return false if "x" is not found or if it's the last character
	}
	...
	public String stringSplosion(String str) {
		...
		for (int i = 0; i < str.length(); i++) {
			one.append(str.substring(0, i + 1));
		}
	...
	public String stringYak(String str) {
		...
		if(str.substring(0).contains("yak")) {
			newString = one.replaceAll("yak", "");
		} else {
			newString = str;
		}
		return newString;
