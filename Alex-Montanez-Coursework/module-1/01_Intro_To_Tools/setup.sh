...
# The URL should look something like: "https://git.techelevator.com/campuses/cle/may-2024/java/instructor-code.git"

upstream_repo="https://git.techelevator.com/campuses/cle/may-2024/java/instructor-code.git"
