...
public class LectureTest {
	...
	public void length_returns_the_number_of_characters_in_a_String() {
		...
		String theOtherString = "Artichoke";

		// Act
		int length = theString.length();
		int theOtherLength = theOtherString.length();

		//
		Assert.assertEquals("The string 'Artichoke' should have 9 characters in length", 9, theOtherLength);
		Assert.assertEquals("The string 'Java' should have 4 characters in length", 4, length);
	}
