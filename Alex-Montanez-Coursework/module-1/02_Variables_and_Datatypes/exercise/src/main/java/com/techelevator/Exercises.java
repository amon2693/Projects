...
public class Exercises {
	...
	int numberOfRemainingRaccoons = numberOfRaccoons - racoonsLeaving;
	...
	int numberOfExtraFlowers = numberOfFlowers - numberOfBees;
        ...
        */
	int numberOfLonelyBirds = 1;
	int numberOfNewBirds = 1;
	int totalBirdsEating = numberOfLonelyBirds + numberOfNewBirds;
	...
	int totalNumberOfOwls = numberOfOwlsOnFence + numberOfNewOwls;
	...
	int totalToucans = toucansOnTree + newToucans;
        ...
        are there than nuts?
        */
	int totalSquirrles = 4;
	int squirrelsWithNuts = 2;
	int totalSquirrelsWithNuts = totalSquirrles - squirrelsWithNuts;

        /* Exercise 10
        10. Mrs. Hilt found a quarter, 1 dime, and 2 nickels. How much money did
        she find?
        */
	double quartersFound = 0.25;
	double dimesFound = 0.10;
	double nickelsFound = 0.10;
	double totalMoneyFound = quartersFound + dimesFound + nickelsFound;
	...
	int totalMuffins = numberOfBrierMuffins + numberOfMacAdamsMuffins + numberOfFlanneryMuffins;
	...
	int differenceOfSnowfall = snowAtHiltHouse - snowAtBrecknockSchool;
	...
	double moneyRemaining = totalMoney - costOfToyTruck - costOfPencil;
	...
	int numberOfSeashellsCurrently = 19;
	int numberOfSeashellsNeeded = numberOfSeashellsWanted - numberOfSeashellsCurrently;
	...
	int totalGreenBalloons = totalBalloons - totalRedBalloons;
	...
	int totalBees =  8;
	int totalNumberOfBeeLegs = numberOfBeeLegs * totalBees;
        ...
        cream cones cost?
        */
	double costOfTwoIceCreamCones = 0.99 * 2;
	...
	int totalRocksMissing = rocksNeeded - rocksCurrently;
	...
	int marblesLeft = marbles - totalMarblesLost;
	...
	int totalTimeShoveling = saturdayShovelingTime + sundayShovelingTime;
	...
	double totalCost = hotDogsBought * costOfHotDog;
	...
	int totalChange = 50;
	int costOfPencils = 7;
	int pencilsBought = totalChange / costOfPencils;
	...
	double moneyOwed = moneyPaid - candyCost;

        /* Exercise 30
        30. Mark has 13 trees in his backyard. If he plants 12 more, how many trees
        will he have?
        */
	int currentTreesPlanted = 13;
	int newTreesPlanted = 12;
	int totalTreesPlanted = currentTreesPlanted + newTreesPlanted;
	...
	int hoursRemaining = hoursInADay * daysToSeeGrandma;
	...
	int cousins = 4;
	int gumToCousins = 5;
	int gumNeeded = cousins * gumToCousins;
	...
	double moneyLeft = danMoney - costOfCandyBar;
	...
	int boatsOnLake = 5;
	int peopleOnBoats = 3;
	int totalPeople = boatsOnLake * peopleOnBoats;
	...
	int totalStickers = pagesOfStickers * stickersOnPage;
	...
	int totalServings = pretzelsMade / pretzelServing;
	...
	int boxesGivenAway = (lemonCupcakesMade - lemonCupcakesLeftAtHome) / lemonCupcakesPerBox;
	...
	int carrotsServedPerPerson = 12;
	int carrotsUneaten = carrotsPrepared % carrotsServedPerPerson;
	...
	int shelvesFilled = totalTeddyBears / maxBearsOnShelf;
	...
	int maxAlbumTotal = 20;
	int albumsNeeded = totalPictures / maxAlbumTotal;
	...
	int tradingCards = 94;
	int maxCardsInBox = 8;
	int boxesFilled = tradingCards / maxCardsInBox;
	int boxesUnfilled = tradingCards % maxCardsInBox;
	...
	double croissantsPerGuest = croissantsBaked / totalGuests;
	 ...
	 double jillRoomPaintPerHour = 1 / 1.9;
	...
	String fullName = lastName + firstName + middleName;
	    ...
	    */
	long totalDistance = 800;
	long distanceTraveled = 537;
	long percentDistanceRemaining = (100) * distanceTraveled / totalDistance;
	}
