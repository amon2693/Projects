...
public class Lecture {
	...
	int numberOfButtonsOnMouse = 3;
		...
		your phone.
		*/
	int percentOnPhone = 100;
		System.out.println("Percentage of phone battery: " + percentOnPhone);
		/*
	...
	mySawWord += 0;
		...
		*/
	double mathDifference = 4.4 / 2.2;
		System.out.println(mathDifference);
		/*
		19. What is 5.4 divided by 2?
		*/
	double divisionOfNumbers = 5.4 / 2;
