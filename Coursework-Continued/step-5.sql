...
VALUES ('Ohiopyle State Park', 'Pennsylvania', '1/1/1965', 19052, 1000000, 
...
VALUES ((SELECT site_id FROM site WHERE site_number = 623), 'Wayne Family', CURRENT_DATE + 10, CURRENT_DATE + 20),
	   ((SELECT site_id FROM site WHERE site_number = 624), 'Parker Family', CURRENT_DATE + 11, CURRENT_DATE + 20),
	   ((SELECT site_id FROM site WHERE site_number = 625), 'Kent Family', CURRENT_DATE + 12, CURRENT_DATE + 20);
/*
